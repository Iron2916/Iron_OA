package com.iron.wechat.controller;
...
import com.iron.vo.wechat.BindPhoneVo;
...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl, HttpServletRequest request) {
        ...
        String redirectURL = wxMpService.getOAuth2Service().buildAuthorizationUrl(userInfoUrl, WxConsts.OAuth2Scope.SNSAPI_USERINFO, URLEncoder.encode(returnUrl.replace("iron", "#")));
        log.info("【微信网页授权】获取code,redirectURL={}", redirectURL);
        return "redirect:" + redirectURL;   // 重定向，到此地址，即下面的处理
    }
